...
export function Sidebar({
  ...
  if (collapsed) {
    return (
      <aside
        className="w-[52px] h-full flex flex-col items-center
      ...
      >
        ...
        <div className="flex items-center justify-between px-3 pt-3 pb-2">
          <div className="flex items-center gap-2">
            <div
              className="w-[26px] h-[26px] rounded-full bg-[#C96A42]
        ...
        <div className="px-2 pb-1">
          <button
            ...
            className="w-full flex items-center gap-2 px-2.5 py-1.5 rounded-lg
                             text-[13px] text-[#3D3530] hover:bg-[#E4E0D5] transition-colors"
          >
            <Play size={14} className="text-[#8A7F72]" />
            <span>Start Requirements Process</span>
          </button>
        </div>
        ...
        <div className="px-2 pb-2">
          <div className="relative">
            <Search
              size={12}
              className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[#B5ADA4]"
            />
            <input
              type="text"
        ...
        <div className="flex-1 overflow-y-auto px-2 pb-2">
          ...
          {!loading && filtered.length === 0 && query && (
            <p className="px-3 py-8 text-center text-xs text-[#B5ADA4]">
              No chats found
            </p>
          )}
        </div>
        ...
        <div className="border-t border-[#E2DCCF] p-2 space-y-0.5">
          ...
          <div className="flex items-center gap-2.5 px-2.5 py-2 mt-0.5 rounded-lg group">
            <div
              className="w-6 h-6 rounded-full bg-[#8A7F72] flex items-center
