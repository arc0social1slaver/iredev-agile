...
class CallableMessageHandler(MessageHandler):
    ...
    def __init__(self, handler_func: Callable[[Message], Optional[Message]], 
...
class CommunicationProtocol:
    ...
    def __init__(self, agent_name: str, session_id: str):
        ...
        logger.info(f"Initialized communication protocol for agent: {agent_name}")
    ...
    def register_callable_handler(self, message_types: List[MessageType],
                                 handler_func: Callable[[Message], Optional[Message]]) -> MessageHandler:
        """
    ...
    def update_state(self, status: str, current_task: Optional[str] = None,
                    load_level: Optional[float] = None, **metadata) -> None:
        """
        Update agent state.
