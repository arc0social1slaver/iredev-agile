    ...
    def generate(
        ...
        if system_messages:
            ...
            formatted_messages.append(
                {"role": "system", "content": system_messages[-1]["content"]}
            )
            ...
            formatted_messages.append(
                {
                    ...
                    "content": (
                        ...
                        else f"Based on your last response: '{formatted_messages[-1]['content']}', please continue."
                    ),
                }
            )
